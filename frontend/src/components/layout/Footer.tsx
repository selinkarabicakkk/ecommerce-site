        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Modern ve kullanıcı dostu bir e-ticaret platformu. Güvenli alışveriş, hızlı teslimat ve
          ...
          <div className="md:col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/products" className="text-base text-gray-600 hover:text-gray-900">
                  Ürünler
                </Link>
              </li>
              <li>
                <Link href="/categories" className="text-base text-gray-600 hover:text-gray-900">
                  Kategoriler
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/shipping" className="text-base text-gray-600 hover:text-gray-900">
                  Kargo Bilgileri
                </Link>
              </li>
              <li>
                <Link href="/returns" className="text-base text-gray-600 hover:text-gray-900">
                  İade Politikası
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-base text-gray-600">
              En son ürünler, indirimler ve kampanyalardan haberdar olun.
            </p>
            <form className="mt-4 sm:flex">
              ...
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="w-full bg-primary border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                >
                  Abone Ol
                </button>
              </div>
